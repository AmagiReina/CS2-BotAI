...
internal static class WindowsPatchDefinitions
{
    internal static IReadOnlyDictionary<string, (string signature, string patch, string expectedOriginal, int patchOffset)> All { get; } =
        ...
        ["Vision_ApproachBody_SkipSkillCheck"] = (
            signature:        "F3 0F 10 40 0C 0F 2F C6 76 ?",
            patch:            "90 90",
            expectedOriginal: "76 ?",
            patchOffset:      8
        ),
        ...
        ["Vision_ApproachBody_SkipHidingSpotCheck"] = (
            signature:        "80 BF ? ? 00 00 00 74 ? 80 7D 43 00 74 ? BA 64 00 00 00 33 C9",
            patch:            "90 90",
            expectedOriginal: "74 ?",
            patchOffset:      7
            ),
        ...
        ["Vision_AlwaysEnterApproachBody"] = (
            signature:        "84 C0 75 ? 48 C7 45 08 00 00 00 00 E9 ? ? ? ?",
            patch:            "EB",
            expectedOriginal: "75",
            patchOffset:       2
        ),
        ...
        ["InViewCone_RemoveOuterFOV"] = (
            signature:        "FF 90 ? ? 00 00 0F 2F 05 ? ? ? ? 76 ? 33 C0 48 83 C4 20 5B C3 48 8B 03 48 8B CB FF 90 ? ? 00 00",
            patch:            "EB",
            expectedOriginal: "76",
            patchOffset:      13
        ),
        ...
        ["OnBombPlanted_AllBotsLearnSite"] = (
            signature:        "48 8B 50 18 80 BA 44 03 00 00 02 0F 85 ? ? ? ? 48 85 DB 0F 84 ? ? ? ? 48 8B CB E8 ? ? ? ?",
            patch:            "90 90 90 90 90 90",
        ...
        ["FlashbangAvoidance_Disable"] = (
            signature:        "E8 ? ? ? ? 49 8B 06 C6 80 7C 5C 00 00 00 32 C0",
            patch:            "90 90 90 90 90 90 90 90 90 90 90 90 90 90 90",
            expectedOriginal: "E8 ? ? ? ? 49 8B 06 C6 80 7C 5C 00 00 00",
            patchOffset:      0
        ),
    };
}
